...
using ArmDisarmAction = auto_apms_px4_interfaces::action::ArmDisarm;
using TakeoffAction = auto_apms_px4_interfaces::action::Takeoff;
using LandAction = auto_apms_px4_interfaces::action::Land;
...
int main(int argc, char * argv[])
{
  ...
  auto node_ptr = std::make_shared<rclcpp::Node>("takeoff_and_land_example");
